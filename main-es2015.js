...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DayItem", function() { return DayItem; });
...
class Action {
    constructor(name, deadline, catagory, completed, catPos) {
        this.name = name;
...
let ActionsService = class ActionsService {
    constructor(timeService, storageService) {
    ...
    addAction(name, deadline, catagory, completed) {
        const adding = new _Pages_to_do_item_model__WEBPACK_IMPORTED_MODULE_2__["Action"](name, deadline, catagory, completed, this.getCatPos(catagory));
    ...
    setWeekView() {
        ...
        const results = this.copyActions().filter(x => week.includes(x.deadline));
        this.currentActions = results;
    }
    // this function changes items possitions within a catagory
    moveCatagory(cata, from, too) {
        const posAry = [];
        const ordered = [];
        for (const i of this.actions) {
            if (i.catagory === cata) {
    ...
    srtByDate() {
        // Declarations
        const dateVal = []; // array filled with the values for the dates
        const newCurentActions = []; // aray filled with the current actions in the new order
    ...
    srtByCata() {
        ...
        for (const i of newAry) {
            newAry[newAry.indexOf(i)].sort((a, b) => {
...
ActionsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_time_service__WEBPACK_IMPORTED_MODULE_3__["TimeService"], _storage_service__WEBPACK_IMPORTED_MODULE_4__["StorageService"]])
], ActionsService);
...
let StorageService = class StorageService {
    ...
    storeData(storing) {
        this.nativeStorage.setItem('stored', storing)
            .then(() => console.log('Stored item!', storing), error => console.error('Error storing item', error));
    }
    retriveData() {
...
StorageService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_2__["NativeStorage"]])
], StorageService);
...
const routes = [
    ...
    {
        path: 'to-do',
        loadChildren: () => __webpack_require__.e(/*! import() | Pages-to-do-to-do-module */ "Pages-to-do-to-do-module").then(__webpack_require__.bind(null, /*! ./Pages/to-do/to-do.module */ "./src/app/Pages/to-do/to-do.module.ts")).then(m => m.ToDoPageModule)
    },
    {
        path: 'add-activ',
        loadChildren: () => __webpack_require__.e(/*! import() | Pages-add-activ-add-activ-module */ "default~Pages-add-activ-add-activ-module~day-view-day-view-module").then(__webpack_require__.bind(null, /*! ./Pages/add-activ/add-activ.module */ "./src/app/Pages/add-activ/add-activ.module.ts")).then(m => m.AddActivPageModule)
    },
    {
        path: 'add-action',
        loadChildren: () => __webpack_require__.e(/*! import() | Pages-add-action-add-action-module */ "common").then(__webpack_require__.bind(null, /*! ./Pages/add-action/add-action.module */ "./src/app/Pages/add-action/add-action.module.ts")).then(m => m.AddActionPageModule)
    },
    {
        path: 'pop-over',
        loadChildren: () => __webpack_require__.e(/*! import() | Pages-pop-over-pop-over-module */ "common").then(__webpack_require__.bind(null, /*! ./Pages/pop-over/pop-over.module */ "./src/app/Pages/pop-over/pop-over.module.ts")).then(m => m.PopOverPageModule)
    },
    {
        path: 'test-page',
        loadChildren: () => __webpack_require__.e(/*! import() | Pages-test-page-test-page-module */ "Pages-test-page-test-page-module").then(__webpack_require__.bind(null, /*! ./Pages/test-page/test-page.module */ "./src/app/Pages/test-page/test-page.module.ts")).then(m => m.TESTPAGEPageModule)
    },
];
...
/* harmony import */ var _Services_actions_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Services/actions.service */ "./src/app/Services/actions.service.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, timeService, actionsService) {
...
AppComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
        ...
        _Services_time_service__WEBPACK_IMPORTED_MODULE_5__["TimeService"],
        _Services_actions_service__WEBPACK_IMPORTED_MODULE_6__["ActionsService"]])
], AppComponent);
...
module.exports = __webpack_require__(/*! /Users/willmoran/Documents/Codeing/DailyPlanner/Dialy-Planner/src/main.ts */"./src/main.ts");
